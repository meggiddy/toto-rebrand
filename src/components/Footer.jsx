...
const Footer = () => {
  return (
    <div>
      <footer className="bg-linear-to-bl from-cyan-500 to-blue-500">
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div className="mx-auto max-w-sm lg:max-w-none">
              <p className="mt-4 text-center text-white lg:text-left lg:text-lg">
                Dive in to our world of fun and excitement with Toto Bouncing
                Castles! Perfect for all ages, our vibrant and safe inflatables
                promise endless joy at any event. Let's make your celebration
                unforgettable!
              </p>
              ...
              <div className="mt-6 flex justify-center gap-4 lg:justify-start">
                <a
                  ...
                  href="https://www.facebook.com/share/1ExwrAfVpS/"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div className="mt-16 border-t border-gray-500 pt-4">
            <p className="text-center text-xs leading-relaxed text-white-500">
              &copy; MegDev {new Date().getFullYear()}. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
