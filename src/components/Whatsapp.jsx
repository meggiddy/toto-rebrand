...
export default function WhatsAppWidget({
  ...
  const phone = useMemo(() => (number || "").replace(/\D/g, ""), [number]);
  ...
  // button style (bg via inline so you can pass any hex)
  const buttonStyle = {
