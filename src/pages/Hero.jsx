...
const Hero = () => {
  return (
    <section
      ...
      style={{
        // gradient overlay baked into the background itself
    ...
    >
      ...
      <div className="flex flex-col items-center text-center">
        ...
        {/* tel link is most reliable */}
        <a
          href="tel:+254722286300"
          className="m-6 flex items-center justify-center gap-4 text-2xl hover:text-cyan-500 cursor-pointer select-none"
          aria-label="Call +254 722 286300"
        >
          <span className="icon-[tabler--phone] text-2xl" aria-hidden="true" />
          <span className="font-serif">+254 722 286300</span>
        </a>

        <div className="mt-6 flex justify-center gap-4 lg:justify-start text-cyan-300">
          <a
